...
namespace jws {
    ...
    bool RcConfig::IsCommentChar(char c)
    {
        switch (c) {
        case '#':
            return true;
    ...
    void RcConfig::Trim(std::string& str)
    {
        if (str.empty())
        {
            return;
    ...
    bool RcConfig::AnalyseLine(const std::string& line, std::string& section, std::string& key, std::string& value)
    {
        if (line.empty())
            return false;
    ...
    bool RcConfig::ReadConfig(const std::string& filename)
    {
        settings_.clear();
    ...
    std::string RcConfig::ReadString(const char* section, const char* item, const char* default_value)
    {
    ...
    int RcConfig::ReadInt(const char* section, const char* item, const int& default_value)
    {
        std::string tmp_s(section);
        std::string tmp_i(item);
        std::map<std::string, std::string> k_v;
    ...
    float RcConfig::ReadFloat(const char* section, const char* item, const float& default_value)
    {
        std::string tmp_s(section);
        std::string tmp_i(item);
        std::map<std::string, std::string> k_v;
    ...
    double RcConfig::ReadDouble(const char* section, const char* item, const double& default_value)
    {
        std::string tmp_s(section);
        std::string tmp_i(item);
        std::map<std::string, std::string> k_v;
